...
const BACKEND_URL = process.env.REACT_APP_BACKEND_URL || 'https://spa-admin-hub-1.preview.emergentagent.com';
      ...
      <div className="max-w-2xl mx-auto">
        <Card className="shadow-lg membership-form">
          ...
          <CardContent className="p-6">
            <div className="mb-6">
              <Alert className="bg-red-700/90 border-red-500/90 mb-4">
                <AlertTriangle className="h-4 w-4 text-red-100" />
                <AlertDescription className="text-white font-bold drop-shadow-2xl" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)', color: '#ffffff' }}>
              ...
              <Alert className="bg-blue-700/90 border-blue-500/90">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {error && (
                <Alert className="bg-red-700/90 border-red-500/90">
                  <AlertTriangle className="h-4 w-4 text-red-100" />
                  <AlertDescription className="text-white font-bold drop-shadow-2xl" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)', color: '#ffffff' }}>{error}</AlertDescription>
                </Alert>
              )}
