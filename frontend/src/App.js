...
function App() {
  ...
  const handleRoomClick = (room) => {
    if (!room.available && room.checkin_id) {
      // Room is occupied, show options to renew or upgrade
      if (window.confirm(`Room ${room.number} is occupied by ${room.customer}. Would you like to upgrade or renew this room?`)) {
  ...
  return (
    <div className="min-h-screen" style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen">
