            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="bg-black border border-red-500 p-6 rounded-lg">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">Customer Management</h3>
                  <p className="text-gray-300">Manage customer registrations, check-ins, and profiles</p>
                </div>
                ...
                <div className="bg-black border border-red-500 p-6 rounded-lg">
                  ...
                  <p className="text-gray-300">Monitor room availability and customer assignments</p>
                </div>
                ...
                <div className="bg-black border border-red-500 p-6 rounded-lg">
                  ...
                  <h3 className="text-lg font-medium text-white mb-2">Reports & Analytics</h3>
                  <p className="text-gray-300">View sales reports and business analytics</p>
                </div>
              </div>
